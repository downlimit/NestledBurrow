...
В живом обсуждении продукта, геймдизайна и пользовательского опыта Лид говорит обычным русским языком и не подменяет смысл внутренними английскими идентификаторами, названиями переменных или придуманными системными ярлыками. Технический термин используется только когда он действительно нужен для решения; тогда сначала даётся его понятный русский смысл. Имена owners, файлов, полей и точные кодовые термины относятся прежде всего к техническому handoff после утверждения дизайна.
