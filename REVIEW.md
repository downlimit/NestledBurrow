...
5. устраняет blockers: механические исправляет сам, для содержательных готовит Codex repair contract в существующем PR и запускает Codex только при наличии реального launch-механизма;
