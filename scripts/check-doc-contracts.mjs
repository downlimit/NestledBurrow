...
requireText(agents, [
  ...
  "Test servers use separate free ports",
  "Codex owns server startup",
  "state remains until success",
  "A successful proof remains valid until its relevant inputs change",
  "execute the publication gate once",
...
requireText(review, ["Codex сам завершает обычную задачу", "одним проходом", "terminal-состояния всех jobs", "Task #001 — Первая расчистка участка (PR #81)", "Codex review, reaction"], "REVIEW.md");
...
requireText(managedPreview, ["task-preview.json", "smokeCanvas", "width !== 320", "detached: true", "windowsHide: true"], "managed task preview");
