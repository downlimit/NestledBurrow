...
assert(workflow.includes("codex login status"), "the runner verifies persisted Codex authentication");
assert(!workflow.includes("Logged in using ChatGPT"), "authentication must use the CLI exit code instead of brittle display text");
