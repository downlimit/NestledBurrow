...
- `populationWealthBalance`: карьерно-экономическое событие имеет базовый шанс `3.5%`/день на eligible household, меняет достаток на ±1 и ограничено максимум `4` событиями на мир в день. Цель `22:31:24:16:7` и спросовые подгруппы ≥`15` лишь смещают вероятность направления. Сумма денег класс не задаёт.
