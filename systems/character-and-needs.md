...
- Natural death is planned at the end of the elder stage, around the 100th game day of life. Population balance must not kill residents early or increase death chance just to hit a target.
- The mature-world target is about `300` persistent residents. Births are the balancing side: below target they become progressively more likely, around target they stay at the normal rate, and above target they become strongly suppressed rather than forcing deaths.
- `youngAdult` and `adult` couples may have children. A normal family target is `1..3` children over the couple's life; the minimum spacing between births remains a tuning value rather than a fixed rule yet.
- New children must become distinct persistent people. Future preferences, character traits, aptitudes and skill tendencies should combine parental influence with variation so generations resemble their families without becoming copies.
