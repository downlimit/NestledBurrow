...
- Stage 9 keeps canonical `ageYears`, `lifeStage`, alive `lifeStatus` and reciprocal family `relationships`; `relatedPersonIds` projects them for visits. Aging is stage-based, not annual: `newborn 4`, `infant 20`, `toddler 28`, `child 56`, `teen 84`, `youngAdult 112`, `adult 168`, `elder 56+` game days. Elder death, birth, relationship mutation and replenishment remain inactive.
