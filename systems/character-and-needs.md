...
- `youngAdult`/`adult` couples may have `1..3` children ≥`6` days apart. Mean births/day: `6@<=240`, `5@260`, `4@280`, `3@300`, `2@320`, `1@340`, `0@>=360`, interpolated with daily variation. Shared ancestry through great-grandparents forbids pairing; farther known ancestry/shared surname only lower pairing priority. Dense bloodlines progressively lose birth priority and may be capped at fewer children. When surname diversity falls or one surname becomes dominant, some normal replenishment slots become adult arrivals: `80%` prefer an extinct surname root, otherwise an unused one. Arrivals have no invented persistent relatives; missing ancestry remains display-only.
