...
- Stage 9 keeps canonical `ageYears`, `lifeStage`, alive `lifeStatus` and reciprocal family `relationships` (`partner`, `parent`, `child`, `sibling`) from `personId`; `relatedPersonIds` is their visit-group projection. The lifecycle does not use a uniform `+1 ageYears` clock. Dynamic aging follows discrete long-life stages: `newborn 4`, `infant 20`, `toddler 28`, `child 56`, `teen 84`, `youngAdult 112`, `adult 168`, `elder 56+` game days. Exact elder death, birth, relationship mutation and replenishment remain inactive.
