import { isLivingPopulationPerson, visitTimeFactorForPerson } from "../character/populationDomain.js";
...
export function selectRelatedVisitCandidates(population, leadPerson, activePersonIds = [], worldTimeSeconds = 0) {
