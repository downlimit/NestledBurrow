...
const CYRILLIC_CAPITAL_GLYPHS = Object.freeze({
...
const CYRILLIC_GLYPHS = Object.freeze({
  ...CYRILLIC_CAPITAL_GLYPHS,
  ...Object.fromEntries(Object.entries(CYRILLIC_CAPITAL_GLYPHS).map(([letter, glyph]) => [letter.toLocaleLowerCase("ru"), glyph])),
});
