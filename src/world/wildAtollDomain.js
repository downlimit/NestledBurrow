...
export const WILD_ATOLL_SEGMENTS = Object.freeze({
  ...
  forestT1: "forest-t1",
  mineT1: "mine-t1",
  forestGroveT2: "forest-grove-t2",
  forestWetlandsT2: "forest-wetlands-t2",
  mineCrystalT2: "mine-crystal-t2",
  mineDepthsT2: "mine-depths-t2",
});
...
const SEGMENT_SPECS = Object.freeze([
  segmentSpec({
    ...
    nextSegments: [WILD_ATOLL_SEGMENTS.forestT1, WILD_ATOLL_SEGMENTS.mineT1],
  }),
  segmentSpec({
    id: WILD_ATOLL_SEGMENTS.forestT1,
    segmentKey: "atoll:segments.forestT1",
    resourcePattern: FOREST_RESOURCE_PATTERN,
    nextSegments: [WILD_ATOLL_SEGMENTS.forestGroveT2, WILD_ATOLL_SEGMENTS.forestWetlandsT2],
  }),
  segmentSpec({
    id: WILD_ATOLL_SEGMENTS.mineT1,
    segmentKey: "atoll:segments.mineT1",
    resourcePattern: MINE_RESOURCE_PATTERN,
    nextSegments: [WILD_ATOLL_SEGMENTS.mineCrystalT2, WILD_ATOLL_SEGMENTS.mineDepthsT2],
  }),
  segmentSpec({
    id: WILD_ATOLL_SEGMENTS.forestGroveT2,
    segmentKey: "atoll:segments.forestGroveT2",
    resourcePattern: FOREST_RESOURCE_PATTERN,
  }),
  segmentSpec({
    id: WILD_ATOLL_SEGMENTS.forestWetlandsT2,
    segmentKey: "atoll:segments.forestWetlandsT2",
    resourcePattern: FOREST_RESOURCE_PATTERN,
  }),
  segmentSpec({
    id: WILD_ATOLL_SEGMENTS.mineCrystalT2,
    segmentKey: "atoll:segments.mineCrystalT2",
    resourcePattern: MINE_RESOURCE_PATTERN,
  }),
  segmentSpec({
    id: WILD_ATOLL_SEGMENTS.mineDepthsT2,
    segmentKey: "atoll:segments.mineDepthsT2",
    resourcePattern: MINE_RESOURCE_PATTERN,
  }),
]);
