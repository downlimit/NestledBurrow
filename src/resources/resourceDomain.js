...
const profiles = [
  {
    id: "log-small",
    nameKey: "build:assets.smallLog",
    kind: "log",
    size: "small",
    requiredTool: "axe",
    preferredAction: "chop",
    actionHp: { chop: "smallLogChopHp" },
    reward: { resource: "wood", amount: 1 },
    visual: "log",
  ...
  {
    id: "log-large",
    nameKey: "build:assets.largeLog",
    kind: "log",
    size: "large",
    requiredTool: "axe",
    preferredAction: "chop",
    actionHp: { chop: { tuning: "smallLogChopHp", multiplier: LARGE_RESOURCE_HP_MULTIPLIER } },
    reward: { resource: "wood", amount: 3 },
    visual: "log",
    footprint: { width: 3, height: 3 },
    collisionTopInset: 4.5,
    prompt: "hud:interaction.chop",
    sfx: "chop",
  },
  {
    id: "stone-small",
    nameKey: "build:assets.smallStone",
    kind: "stone",
    size: "small",
    requiredTool: "pickaxe",
    preferredAction: "mine",
    actionHp: { mine: 7 },
    reward: { resource: "stone", amount: 1 },
    visual: "stone",
    footprint: { width: 2, height: 2 },
    collisionTopInset: 3,
    collisionLeftInset: 1,
    collisionRightInset: 2,
    prompt: "hud:interaction.mine",
    sfx: "mine",
  },
  {
    id: "stone-large",
    nameKey: "build:assets.largeStone",
    kind: "stone",
    size: "large",
    requiredTool: "pickaxe",
    preferredAction: "mine",
    actionHp: { mine: { value: 7, multiplier: LARGE_RESOURCE_HP_MULTIPLIER } },
    reward: { resource: "stone", amount: 3 },
    visual: "stone",
    footprint: { width: 3, height: 3 },
    collisionTopInset: 4.5,
    prompt: "hud:interaction.mine",
  ...
  {
    id: "ruby-node",
    nameKey: "build:assets.rubyNode",
    kind: "ruby",
    size: "small",
    requiredTool: "pickaxe",
    preferredAction: "mine",
    actionHp: { mine: 5 },
    reward: { resource: "rubies", amount: 1 },
    visual: "ruby",
    footprint: { width: 2, height: 2 },
    prompt: "hud:interaction.mine",
    sfx: "mine",
  ...
  {
    id: "tree-planted",
    nameKey: "build:assets.tree",
    kind: "plant",
    size: "large",
    requiredTool: "axe",
    preferredAction: "chop",
    actionHp: { chop: "smallLogChopHp" },
    reward: { resource: "wood", amount: 5 },
    visual: "tree",
    footprint: { width: 2, height: 2 },
    collisionRect: { left: 16, top: 48, right: 32, bottom: 64 },
    prompt: "hud:interaction.chop",
    sfx: "chop",
  },
  {
    id: "berry-bush",
    nameKey: "build:assets.berryBush",
    kind: "berry",
    size: "small",
    requiredTool: null,
    preferredAction: "gather",
    actionHp: { gather: 1 },
    reward: { resource: "berry", amount: 1 },
    visual: "berry",
    footprint: { width: 2, height: 2 },
    collisionTopInset: 4,
    prompt: "hud:interaction.gatherBerries",
    sfx: "inventory-change",
  },
].map(freezeProfile);
