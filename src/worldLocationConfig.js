...
export const TRANSPORT_PROFILE = deepFreeze({
  ...
  shell: [
    { id: "top", left: 0, top: 0, right: 32, bottom: 8 },
  ...
  visuals: [
    ...
    { x: 0, y: 1, frame: HOUSE_FRAMES.transport.pillarLeft, crop: { x: 0, width: 8 } },
    { x: 1.5, y: 1, frame: HOUSE_FRAMES.transport.pillarRight, crop: { x: 8, width: 8 } },
  ],
