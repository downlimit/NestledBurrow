...
| Дикий Атолл, прогноз дорог, transient-забег, трава, маршрутные награды и будущая глубина | `systems/wild-atoll.md` | `src/world/wildAtollDomain.js`, `src/world/wildAtollRuntime.js`; `WildAtollPrototype/` остаётся standalone design aid | `check:task-068`, `check:docs` |
