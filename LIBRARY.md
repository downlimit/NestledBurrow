...
`GAME.md` — фантазия и направление игры; `LIBRARY.md` — краткая карта систем и маршруты к их `systems/*.md`, основным владельцам и проверкам. Подробности механик живут в system-документах, не здесь.
