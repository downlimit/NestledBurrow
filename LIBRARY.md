...
| persistent population, generations, names, family tree, inspection, demand, offscreen needs | `systems/character-and-needs.md` + `systems/persistence.md` | `src/character/populationDomain.js`, `src/character/populationLifecycleDomain.js`, `src/character/personNames.js`, `src/character/personNameLocalization.js`, `src/character/personFamilyTree.js`, `src/character/personInspectionRuntime.js`, `src/session/sessionPersistence.js` | `check:task-086`, `check:task-088`, `check:task-090`, `check:task-096`, `check:task-098`, `check:task-099`, `check:task-100` |
