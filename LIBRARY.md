...
| persistent population, generations, person inspection/editing, demand, offscreen needs | `systems/character-and-needs.md` + `systems/persistence.md` | `src/character/populationDomain.js`, `src/character/populationLifecycleDomain.js`, `src/character/personInspectionRuntime.js`, `src/ui/needsPanelPresentation.js`, `src/ui/needBarGeometry.js`, `src/session/sessionPersistence.js` | `check:task-086`, `check:task-088`, `check:task-090`, `check:task-096`, `check:task-098`, `check:task-099`, `check:task-100` |
