...
- основные инварианты движения, collision environment, персонажей, мира, ввода, runtime-компонентов и визуального контракта покрыты проверками.
...
### Приоритет 1 — при добавлении взаимодействий и разных персонажей
...
### Приоритет 2 — при появлении реального AI и контента
...
Общий `ControllerCommand`, изолированный controller snapshot, `MobileJoystick`, `MovementDebugPanel`, явные actor profiles, collision environment и legacy room cleanup реализованы и покрыты применимыми проверками. Следующая архитектурная очередь начинается с разделения motor/visual, character registry, сериализуемого session state и interaction/world-runtime границ.
